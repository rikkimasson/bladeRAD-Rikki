function [signal, noise, SNR, slices_range_doppler, index_signal_max] = slice_SNR(range_doppler_slice, roi_indices_rows, roi_indices_cols)
...
noise = 20*log10(mean(complex_2_abs_roi(:)));
