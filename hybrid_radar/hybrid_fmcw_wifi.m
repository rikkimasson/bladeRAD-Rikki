...
% Parameters not configurable by user 
    ...
    passive_number_cap_samps = capture_duration/passive_sample_duration;
...
%% FMCW Processing and Print RTI
    % load refsig for deramping
        refsig = load_refsig(Bw_M,FMCW_Fc,pulse_duration);    
    % load Signal, Mix and Dermap Signal  
        file_location = exp_dir + 'fmcw_' + Experiment_ID;
        [max_range_actual,processed_signal] = deramp_and_decimate(file_location,max_range,refsig,capture_duration,number_pulses,FMCW_Fs,slope);
