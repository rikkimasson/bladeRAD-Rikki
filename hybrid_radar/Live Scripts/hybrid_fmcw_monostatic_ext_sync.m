...
% Capture parameters 
Experiment_ID = 136;    % Expeiment Name
...
% FMCW Parameters 
active.Fs = 20e6;          % Sample Rate of SDR per I & Q (in reality Fs is double this)
active.pulse_duration = 0.5e-3;   % Desired Pulse Duration 
active.Bw = 20e6;          % LFM Bandwidth 
...
passive.Sur_gain = 27; % 40dB seems good for C-Band Patch Antennas [-16, 60]
...
if process_active == true
    ...
    % Derive range and time axis 
     ...
     % Plot RTI
        ...
        figure;
        fig = imagesc(1:active.range_bins,active.time_axis,RTI_plot,[-80,0]);   
            ylabel('Time (s)');
            xlabel('Range (m)');
